...
export class AuthController {
    ...
    async updateProfile(req, res, next) {
        try {
            ...
            res.status(200).json(ResponseFormatter.success(updatedProfile, "Profile updated successfully", 200));
        } catch (error) {
            next(error);
        }
    }
    ...
    async changePassword(req, res, next) {
        try {
            ...
            res.status(200).json(ResponseFormatter.success({}, "Password changed successfully", 200));
        } catch (error) {
            next(error);
        }
    }
